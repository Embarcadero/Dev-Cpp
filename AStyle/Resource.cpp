...
namespace Globals {
	...
	DLLIMPORT LPD3DXEFFECT FX; // shader interface
	DLLIMPORT LPDIRECT3DDEVICE9 d3ddev; // d3d interface to graphics card
	DLLIMPORT HWND hwnd = NULL; // main window
...
#define cpuid(func,ax,bx,cx,dx)\
	...
	DLLIMPORT float4x4 GetLookAtMatrix(const D3DXVECTOR3& from,const D3DXVECTOR3& to) {
	...
	DLLIMPORT void GetExecutableDir(const char* file,const char* folder,char* fullpath) {
